...
public class LocalVarDef_1 extends SyntaxTreeNode{
	...
	public String generateAsm() {
		return generateStatementAsm();
	}
	
	public String generateStatementAsm() {
		switch(this.statement.ruleType) {
			case RuleType.STATEMENT:
				return ((Statement) this.statement).generateAsm();
			case RuleType.STATEMENT_1:
				return ((Statement_1) this.statement).generateAsm();
			case RuleType.STATEMENT_2:
				return ((Statement_2) this.statement).generateAsm();
			case RuleType.STATEMENT_3:
				return ((Statement_3) this.statement).generateAsm();
			case RuleType.STATEMENT_4:
				return ((Statement_4) this.statement).generateAsm();
			case RuleType.STATEMENT_5:
				return ((Statement_5) this.statement).generateAsm();
			case RuleType.STATEMENT_6:
				return ((Statement_6) this.statement).generateAsm();
		}
		return null;
	}
}
